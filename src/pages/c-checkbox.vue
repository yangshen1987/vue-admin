  ...
  <div class="priview-box">
   ...
   -->
      <div class="priview-box">
        ...
        <p>真实初始结果：{{checkArr}}</p>
        <m-checkbox v-model="checkArr"
                    val="aaa"
                    checked>aaa</m-checkbox>
        <m-checkbox v-model="checkArr"
                    val="bbb"
                    :checked="false">bbb</m-checkbox>
        <m-checkbox v-model="checkArr"
                    val="ccc">ccc</m-checkbox>
        <m-checkbox v-model="checkArr"
                    val="eee">eee</m-checkbox>
      </div>

      <div class="priview-box">
        <p>期望初始结果：{{['abc', 'eee', 'aaa',]}}</p>
        <p>真实初始结果：{{checkArr2}}</p>
        <m-checkbox-group v-model="checkArr2"
                          @change="change">
          <m-checkbox val="aaa"
                      checked>aaa</m-checkbox>
          <m-checkbox val="bbb"
